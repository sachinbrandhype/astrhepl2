...
<div class="group-input">
                                ...
                                <input  name="fullname" class="form-control"  placeholder="Name" required="">
                            </div>
                            ...
                            <div class="group-input">
                                ...
                                <input  name="m-date" type='date'  class="form-control"   placeholder="Date of Year" required="">
                            </div>
                           ...
                           <div class="group-input">
                                ...
                                <input  name="m-time" type='time'class="form-control"  required="">
                            </div>  
...
<div class="group-input">
                                <label for="username">Name</label>
                                <input  name="f_fullname" class="form-control"  placeholder="Name" required="">
                            </div>

                            
                            <div class="group-input">
                                <label for="pass">Date</label>
                                <input  name="f-date" type='date' class="form-control"   placeholder="Date of Year" required="">
                            </div>
                           ...
                           <div class="group-input">
                                ...
                                <input  name="f-time" type='time' class="form-control"  required="">
                            </div>  
