            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="register-form">
                        <h2>Sadhesati Remedies</h2>
                        <form method='post' action='sadhesati-remedies.php'>
                    ...
                    <div class="form-group">
                        <input type="hidden" name="latitude"  class="form-control drop_lat" id="input_lat"  placeholder="Latitude" readonly required>
                    </div>

                    <div class="form-group">
                        <input type="hidden" name="longitude" class="form-control drop_lng"  placeholder="Longitude" readonly required>
                    </div>
